    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Bits addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->signMessage->setVisible(false);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Bits addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you."));
